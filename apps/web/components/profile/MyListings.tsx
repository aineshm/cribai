    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-teal-50 mb-4">
          <Home className="size-7 text-teal-600" />
        </div>
    ...
    <div className="space-y-2">
      {listings.map((listing) => (
        <Link
          ...
          className="flex items-center gap-4 p-4 rounded-2xl border border-gray-100 bg-white hover:border-teal-200 hover:bg-teal-50/30 transition-all"
        >
          ...
          {listing.photoUrl ? (
            ...
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-teal-50 to-teal-100">
              <Home className="size-6 text-teal-600 opacity-50" />
            </div>
          )}
