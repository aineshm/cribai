...
export function ExploreLayout({ listings }: ExploreLayoutProps) {
  ...
  return (
    <>
      ...
      {/* Desktop: 60/40 split */}
      <div className="hidden lg:grid lg:grid-cols-[3fr_2fr] gap-6 h-[calc(100vh-var(--app-chrome-height))]">
        <div className="overflow-y-auto rounded-[2rem] border border-[var(--surface-200)] bg-white/95 p-5 shadow-[0_18px_40px_rgba(15,23,42,0.05)] scrollbar-hide">
          <ListingGrid listings={listings} />
        </div>
