...
export function AuthSplitLayout({ children }: AuthSplitLayoutProps) {
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12 text-white bg-red-900">
        {/* Radial gradient overlay */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(20,184,166,0.15),transparent_60%)]" />
        {/* Amber blur glow */}
        <div className="absolute -left-20 -bottom-20 h-[600px] w-[600px] rounded-full bg-slate-400/10 blur-[120px]" />
      ...
      <div className="flex w-full lg:w-1/2 items-start pt-24 sm:items-center sm:pt-0 justify-center p-8 lg:px-20 lg:py-24">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 flex items-center gap-2 lg:hidden">
            ...
            <span className="font-[family-name:var(--font-display)] text-xl font-bold tracking-tight text-red-800">
              CribAI
            </span>
          </div>
          {children}
